...
interface EditLinkModalProps {
    ...
    onSave: (id: string, name: string, shortCode: string) => void,
    onClose: () => void
}
...
export const EditLinkModal: React.FC<EditLinkModalProps> = ({ link, onSave, onClose }) => {
    ...
    const handleSubmit = (e: Event) => {
        ...
        onSave(link.id, name.trim(), shortCode.trim())
    }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
            <div className="w-full max-w-md rounded-2xl bg-white shadow-xl">
                ...
                <form onSubmit={() => handleSubmit} className="p-6 space-y-4">
                    ...
                    <div>
                        <label htmlFor="link-name" className="block text-sm font-medium text-emerald-950 mb-2">
                            Link Name
                        </label>
                        <input
                            id="link-name"
                            ...
                            autoFocus
                        />
                        <p className="mt-1 text-xs text-emerald-600">{name.length}/100 characters</p>
                    </div>
