    ...
    return (
        <aside className="w-64 bg-gradient-to-b from-emerald-950 to-emerald-900 text-white flex flex-col h-screen md:h-full shadow-lg">
            ...
            <div className="border-t border-emerald-700/50 p-4 mt-auto">
                <button className="w-full flex items-center justify-center gap-2 rounded-xl bg-emerald-500 px-4 py-3 text-sm font-medium text-white hover:bg-emerald-600 transition-all duration-200 shadow-lg shadow-emerald-500/20">
