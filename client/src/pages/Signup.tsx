        ...
        <div className="relative z-10 w-full max-w-md px-4">
          ...
          <div className="text-center text-white mb-8">
            <div className="flex justify-center mb-4">
              <UserPlus className="h-12 w-12 text-emerald-300" />
            </div>
            <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">Get started</h2>
            <p className="mt-2 text-pretty text-sm/6 text-white/70 md:text-base">
              Create your GreenLink account in seconds
            </p>
          </div>
