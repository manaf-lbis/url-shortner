...
//                         </div>
//                         <h2 className="text-balance text-3xl font-semibold tracking-tight md:text-4xl">Welcome back</h2>
//                         <p className="mt-2 text-pretty text-sm/6 text-white/70 md:text-base">Sign in to your GreenLink account</p>
//                     </div>
...
//                         <Link to="/forgot-password" className="font-medium text-emerald-300 hover:text-emerald-200 transition">
//                             Forgot password?
//                         </Link>
//                     </div>
//                 </div>
